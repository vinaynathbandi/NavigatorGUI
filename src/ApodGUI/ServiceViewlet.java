...
public class ServiceViewlet {
    ...
    @Parameters({"Servicename", "DestinationManager"})
	public static void AddServiceViewlet(String Servicename, String DestinationManager, ITestContext context) throws InterruptedException
	{
		//Click on Viewlet
