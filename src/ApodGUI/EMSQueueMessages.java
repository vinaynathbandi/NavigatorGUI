...
public class EMSQueueMessages 
{
	...
	@Parameters({"sDriver", "sDriverpath", "Dashboardname", "DownloadPath", "MessageData", "QueueName"})
	@Test
	public static void Login(String sDriver, String sDriverpath, String Dashboardname, String DownloadPath, String MessageData, String QueueName) throws Exception
	{
		Settings.read();
