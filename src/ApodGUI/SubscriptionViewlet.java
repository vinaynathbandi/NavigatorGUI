...
public class SubscriptionViewlet {
	...
	@Parameters({"AddSubscriptionName", "DestinationTopicName", "TopicStringData"})
	
	@Test(priority=2)
	public void CreateSubscriptionFromOptions(String AddSubscriptionName, String DestinationTopicName, String TopicStringData, ITestContext context) throws InterruptedException
	{
	...
	@Parameters({"DestinationNodeName", "DestinationManagerName", "AddSubscriptionNameFromIcon", "DestinationIconTopicName", "TopicStringDataFromICon", "NodeNameFromIcon", "DestinationManagerFromIcon", "DestinationQueueFromIcon"})
	@TestRail(testCaseId=201)
	@Test(priority=15)
	public void CreateSubscriptionFromPlusIcon(String DestinationNodeName, String DestinationManagerName, String AddSubscriptionNameFromIcon, String DestinationIconTopicName, String TopicStringDataFromICon, String NodeNameFromIcon, String DestinationManagerFromIcon, String DestinationQueueFromIcon,ITestContext context) throws InterruptedException
	{
