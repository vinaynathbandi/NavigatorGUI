...
public class EMSTopic {
	...
	@Parameters({ "sDriver", "sDriverpath", "Dashboardname", "wgs", "TopicName" })
	@Test
	public static void Login(String sDriver, String sDriverpath, String Dashboardname, int wgs, String TopicName ) throws Exception {
		 ...
		 * Thread.sleep(2000); dd.selectByIndex(wgs);
		 * 
		 * //Selection of Node
	...
	@Test(priority = 17)
	public static void ShowObjectAttributesForTopic(String SchemaName, ITestContext context)
		...
		try {
			...
			context.setAttribute("Comment",
					"Got exception while showing object attributes, check details: " + e.getMessage());
		}
	}
	...
	@Test(priority = 2)
	public void CreateTopicFromPlusIcon(String TopicNameFromIcon, ITestContext context)
			throws InterruptedException {
		...
		/*
		 * //Select Node driver.findElement(By.xpath("//div[2]/input")).click();
	...
	@Test(priority = 4)
	public static void CopyAsFromCommands(String CopyObjectName, String TopicNameFromIcon, ITestContext context)
			throws InterruptedException {
		// Store the EMS topic into string
		// String
		// TopicNameFromOptions=driver.findElement(By.xpath("//datatable-body-cell[4]/div/span")).getText();
		...
		Mousehovercopy.moveToElement(driver.findElement(By.xpath("//app-dropdown[@id='dropdown-block']/div/ul/li[2]")))
				.perform();
	...
	@Test(priority = 5)
	public static void DeleteFromCommands(String TopicNameFromIcon, String CopyObjectName, ITestContext context)
			throws InterruptedException {
	...
	@Test(priority = 6)
	public void EMSTopicPublish(String MessageData, String PropertyName, String PropertyValue, ITestContext context)
			throws InterruptedException {
		// Select publish From commands
		driver.findElement(By.xpath(
				"/html/body/app-root/div/app-main-page/div/app-tab/div/div/div[3]/app-viewlet/div/ngx-datatable/div/datatable-body/datatable-selection/datatable-scroller/datatable-row-wrapper[1]/datatable-body-row/div[2]/datatable-body-cell[1]/div/input"))
				.click();
		Actions Mousehovercopy = new Actions(driver);
		Mousehovercopy.moveToElement(driver.findElement(By.xpath("//app-dropdown[@id='dropdown-block']/div/ul/li[2]")))
				.perform();
	...
	@Parameters({ "MessageData", "PropertyName", "PropertyValue", "AddSubscriptionName", 
			"DestinationManager", "DestinationQueue", "DestinationTopicName" })

	@Test(priority = 66)
	public void PublishFromCommands(String MessageData, String PropertyName, String PropertyValue,
			String AddSubscriptionName,  String DestinationManager,
			String DestinationQueue, String DestinationTopicName) throws InterruptedException {
		this.Addsubscription(AddSubscriptionName,  DestinationManager, DestinationQueue,
	...
	@Test(priority = 9)
	public static void AddToFavoriteViewlet(String FavoriteViewletName, int Favwgs, ITestContext context)
			throws InterruptedException {
	...
	public void CopyAsFromCommandsForMultipleTopics(String CopyObjectNameForMultiple) throws InterruptedException {
		...
		driver.findElement(By.xpath(
				...
				.click();
		Actions Mousehovercopy = new Actions(driver);
		Mousehovercopy.moveToElement(driver.findElement(By.xpath("//app-dropdown[@id='dropdown-block']/div/ul/li")))
				.perform();
		driver.findElement(By.xpath("//app-dropdown[@id='dropdown-block']/div/ul/li[2]/ul/li")).click();
		Thread.sleep(1000);
		 ...
		 * CopyObjectNameForMultiple); Thread.sleep(2000);
		 */
	...
	public void DeleteFromCommandsForMultipleTopics(String CopyObjectNameForMultiple) throws InterruptedException {
		...
		driver.findElement(By.xpath(
				...
				.click();
		driver.findElement(By.xpath(
				"/html/body/app-root/div/app-main-page/div/app-tab/div/div/div[3]/app-viewlet/div/ngx-datatable/div/datatable-body/datatable-selection/datatable-scroller/datatable-row-wrapper[2]/datatable-body-row/div[2]/datatable-body-cell[1]/div/input"))
				.click();
		Actions Mousehovercopy = new Actions(driver);
		Mousehovercopy.moveToElement(driver.findElement(By.xpath("//app-dropdown[@id='dropdown-block']/div/ul/li")))
				.perform();
	...
	@Parameters({ "AddSubscriptionNameforMultiple", "MessageDataForMultiple", "PropertyNameForMultiple",
			"PropertyValueForMultiple", "DestinationManager", "DestinationQueue",
			"DestinationTopicName" })
	@Test(priority = 13)
	public void PublishFromCommandsForMultipleTopics(String AddSubscriptionNameforMultiple,
			String MessageDataForMultiple, String PropertyNameForMultiple, String PropertyValueForMultiple, String DestinationManager, String DestinationQueue,
			String DestinationTopicName) throws InterruptedException {
		this.AddsubscriptionForMultiple(AddSubscriptionNameforMultiple, DestinationManager,
				DestinationQueue, DestinationTopicName);
	...
	public void MultipleProperties(ITestContext context) throws InterruptedException {
		...
		// String
		// FirstCommunicationinfo=driver.findElement(By.id("communicationInfo")).getAttribute("value");
		...
		// String
		// SecondCommunicationinfo=driver.findElement(By.id("communicationInfo")).getAttribute("value");
	...
	@Test(priority = 15)
	public static void AddToFavoriteForMultipleTopics(String FavoriteViewletName, ITestContext context)
			throws InterruptedException {
		// Store the Topic Names into string
		String TopicName2 = driver
				.findElement(By
						.xpath("//datatable-row-wrapper[2]/datatable-body-row/div[2]/datatable-body-cell[4]/div/span"))
				.getText();
		String TopicName3 = driver
				.findElement(By
						.xpath("//datatable-row-wrapper[2]/datatable-body-row/div[2]/datatable-body-cell[4]/div/span"))
				.getText();
		...
		driver.findElement(By.xpath(
				...
				.click();
		driver.findElement(By.xpath(
				"/html/body/app-root/div/app-main-page/div/app-tab/div/div/div[1]/app-viewlet/div/ngx-datatable/div/datatable-body/datatable-selection/datatable-scroller/datatable-row-wrapper[3]/datatable-body-row/div[2]/datatable-body-cell[1]/div/input"))
				.click();
		driver.findElement(By.xpath("//ul[2]/li")).click();
		Thread.sleep(1000);
	...
	@Parameters({ "AddSubscriptionName",  "DestinationManager", "DestinationQueue",
			"DestinationTopicName" })
	public void Addsubscription(String AddSubscriptionName, 
			String DestinationManager, String DestinationQueue, String DestinationTopicName)
			throws InterruptedException {
		// Click on Viewlet
		driver.findElement(By.cssSelector("button.g-button-blue.button-add")).click();
		driver.findElement(By.cssSelector("div.mod-select-viewlet-buttons > button.g-button-blue")).click();
		...
		driver.findElement(By.xpath(
				"/html/body/app-root/div/app-main-page/div/app-tab/div/div/div[4]/app-viewlet/div/ngx-datatable/div/datatable-body/datatable-selection/datatable-scroller/datatable-row-wrapper[1]/datatable-body-row/div[2]/datatable-body-cell[1]/div/input"))
				.click();
		driver.findElement(By.xpath("//app-dropdown[@id='dropdown-block']/div/ul/li[4]")).click();
		Thread.sleep(1000);
		...
		try {
			...
			List<WebElement> Topic = driver.findElement(By.className("ng-dropdown-panel-items"))
					.findElements(By.className("ng-option"));
		...
		// Select WGS name
		/*
		 * driver.findElement(By.xpath("//ng-select[@id='destinationNodeName']/div")).
		 * click();
		 * driver.findElement(By.xpath("//ng-select[@id='destinationNodeName']/div")).
		 * sendKeys("DESKTOP-E1JT2VR"); //span[@class, 'ng-option-label
		 * ng-star-inserted']
		 */

		try {
			driver.findElement(By.id("destinationNodeName")).click();
			List<WebElement> Node = driver.findElement(By.className("ng-dropdown-panel-items"))
					.findElements(By.className("ng-option"));
		...
		try {
			...
			List<WebElement> Manager = driver.findElement(By.className("ng-dropdown-panel-items"))
					.findElements(By.className("ng-option"));
		...
		try {
			...
			List<WebElement> QueueName = driver.findElement(By.className("ng-dropdown-panel-items"))
					.findElements(By.className("ng-option"));
	...
	@Parameters({ "AddSubscriptionNameforMultiple",  "DestinationManager",
			"DestinationQueue", "DestinationTopicName" })
	public void AddsubscriptionForMultiple(String AddSubscriptionNameforMultiple,  String DestinationManager, String DestinationQueue, String DestinationTopicName)
			throws InterruptedException {
		// click on check box and choose create subscription
		driver.findElement(By.xpath(
				"/html/body/app-root/div/app-main-page/div/app-tab/div/div/div[4]/app-viewlet/div/ngx-datatable/div/datatable-body/datatable-selection/datatable-scroller/datatable-row-wrapper[1]/datatable-body-row/div[2]/datatable-body-cell[1]/div/input"))
