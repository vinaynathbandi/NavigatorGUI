...
public class TransportViewlet 
{
	...
	public static void AddTransportViewlet(String Transportname,  ITestContext context) throws InterruptedException
	{
		//Click on Viewlet
	...
	@Test(priority=9)
	public static void ShowObjectAttributesForTransport(String schemaName, ITestContext context) throws InterruptedException
	{		
		try {
	...
	public static void CompareTransports(ITestContext context) throws InterruptedException
	{
		...
		driver.findElement(By.xpath("/html/body/app-root/div/app-main-page/div/app-tab/div/div/div[1]/app-viewlet/div/ngx-datatable/div/datatable-body/datatable-selection/datatable-scroller/datatable-row-wrapper/datatable-body-row/div[2]/datatable-body-cell/div/input")).click();
		driver.findElement(By.xpath("/html/body/app-root/div/app-main-page/div/app-tab/div/div/div[1]/app-viewlet/div/ngx-datatable/div/datatable-body/datatable-selection/datatable-scroller/datatable-row-wrapper[1]/datatable-body-row/div[2]/datatable-body-cell[1]/div/input")).click();
