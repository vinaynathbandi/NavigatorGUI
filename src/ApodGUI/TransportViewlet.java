...
public class TransportViewlet {
	...
	public static void Login(String sDriver, String sDriverpath, String URL, String uname, String password,
			String Dashboardname, int wgs) throws Exception {
	...
	public static void AddTransportViewlet(String Transportname, ITestContext context)
	...
	@Test(priority = 9)
	public static void ShowObjectAttributesForTransport(String schemaName, ITestContext context)
			throws InterruptedException {
		try {
			ObjectsVerificationForAllViewlets obj = new ObjectsVerificationForAllViewlets();
			obj.TransportObjectAttributesVerification(driver, schemaName);
			context.setAttribute("Status", 1);
			context.setAttribute("Comment", "Show object attributes option for transport is working fine");
		} catch (Exception e) {
			context.setAttribute("Status", 5);
			context.setAttribute("Comment",
					"Exception occured while checking show object attributes option, check details: " + e.getMessage());
		}
	}
	...
	public static void TransportEvents(ITestContext context) throws InterruptedException {
		...
		if (Eventdetails.equalsIgnoreCase("Event #")) {
			...
			context.setAttribute("Status", 1);
			context.setAttribute("Comment", "Transport events are working fine");
		} else {
			System.out.println("Events page is not opened");
			context.setAttribute("Status", 5);
			context.setAttribute("Comment", "Failed to load transport events");
	...
	@Test(priority = 6)
	public static void CompareTransports(ITestContext context) throws InterruptedException {
		// Select compare option
		driver.findElement(By.xpath(
				"/html/body/app-root/div/app-main-page/div/app-tab/div/div/div[1]/app-viewlet/div/ngx-datatable/div/datatable-body/datatable-selection/datatable-scroller/datatable-row-wrapper/datatable-body-row/div[2]/datatable-body-cell/div/input"))
				.click();
		driver.findElement(By.xpath(
				"/html/body/app-root/div/app-main-page/div/app-tab/div/div/div[1]/app-viewlet/div/ngx-datatable/div/datatable-body/datatable-selection/datatable-scroller/datatable-row-wrapper[1]/datatable-body-row/div[2]/datatable-body-cell[1]/div/input"))
				.click();
	...
	@Parameters({ "FavoriteViewletName", "Favwgs" })
	@Test(priority = 7)
	public static void AddToFavoriteForMultipleTransports(String FavoriteViewletName, int Favwgs)
			throws InterruptedException {
		// Store the Transport Name into string
		String TransportName = driver.findElement(By.xpath("//datatable-body-cell[3]/div/span")).getText();
